...
export type UpdateProjectsByIdFilesByFileIdRequest =
  paths['/api/projects/{id}/files/{fileId}']['put']['requestBody']['content']['application/json']
...
export type CreateProjectsByIdSuggestFilesRequest =
  paths['/api/projects/{id}/suggest-files']['post']['requestBody']['content']['application/json']
...
export type UpdateTickettaskRequest =
  paths['/api/tickettasks/{tickettaskId}']['put']['requestBody']['content']['application/json']
...
export type CreateChatsByChatIdMessagesRequest =
  paths['/api/chats/{chatId}/messages']['post']['requestBody']['content']['application/json']
...
export type UpdateChatmessageRequest =
  paths['/api/chatmessages/{chatmessageId}']['put']['requestBody']['content']['application/json']
...
export type GetClaudeagentsResponse =
  paths['/api/claudeagents']['get']['responses']['200']['content']['application/json']
export type CreateClaudeagentResponse =
  paths['/api/claudeagents']['post']['responses']['201']['content']['application/json']
export type CreateClaudeagentRequest = paths['/api/claudeagents']['post']['requestBody']['content']['application/json']
export type GetClaudeagentResponse =
  paths['/api/claudeagents/{claudeagentId}']['get']['responses']['200']['content']['application/json']
export type UpdateClaudeagentResponse =
  paths['/api/claudeagents/{claudeagentId}']['put']['responses']['200']['content']['application/json']
export type UpdateClaudeagentRequest =
  paths['/api/claudeagents/{claudeagentId}']['put']['requestBody']['content']['application/json']
export type DeleteClaudeagentResponse =
  paths['/api/claudeagents/{claudeagentId}']['delete']['responses']['200']['content']['application/json']
export type GetClaudecommandsResponse =
  paths['/api/claudecommands']['get']['responses']['200']['content']['application/json']
export type CreateClaudecommandResponse =
  paths['/api/claudecommands']['post']['responses']['201']['content']['application/json']
export type CreateClaudecommandRequest =
  paths['/api/claudecommands']['post']['requestBody']['content']['application/json']
export type GetClaudecommandResponse =
  paths['/api/claudecommands/{claudecommandId}']['get']['responses']['200']['content']['application/json']
export type UpdateClaudecommandResponse =
  paths['/api/claudecommands/{claudecommandId}']['put']['responses']['200']['content']['application/json']
export type UpdateClaudecommandRequest =
  paths['/api/claudecommands/{claudecommandId}']['put']['requestBody']['content']['application/json']
export type DeleteClaudecommandResponse =
  paths['/api/claudecommands/{claudecommandId}']['delete']['responses']['200']['content']['application/json']
...
export type CreateClaudehookResponse =
  paths['/api/claudehooks']['post']['responses']['201']['content']['application/json']
...
export type GetClaudehookResponse =
  paths['/api/claudehooks/{claudehookId}']['get']['responses']['200']['content']['application/json']
export type UpdateClaudehookResponse =
  paths['/api/claudehooks/{claudehookId}']['put']['responses']['200']['content']['application/json']
export type UpdateClaudehookRequest =
  paths['/api/claudehooks/{claudehookId}']['put']['requestBody']['content']['application/json']
export type DeleteClaudehookResponse =
  paths['/api/claudehooks/{claudehookId}']['delete']['responses']['200']['content']['application/json']
...
export type CreateProviderkeieRequest =
  paths['/api/providerkeies']['post']['requestBody']['content']['application/json']
...
export type UpdateProviderkeieRequest =
  paths['/api/providerkeies/{providerkeyId}']['put']['requestBody']['content']['application/json']
...
export type CreateSelectedfileRequest =
  paths['/api/selectedfiles']['post']['requestBody']['content']['application/json']
...
export type UpdateSelectedfileRequest =
  paths['/api/selectedfiles/{selectedfileId}']['put']['requestBody']['content']['application/json']
...
export type UpdateActivetabRequest =
  paths['/api/activetabs/{activetabId}']['put']['requestBody']['content']['application/json']
...
export type UpdateProviderKeyRequest =
  paths['/api/provider-keys/{id}']['put']['requestBody']['content']['application/json']
...
export type CreateProviderKeysByProviderKeyIdTestRequest =
  paths['/api/provider-keys/{providerKeyId}/test']['post']['requestBody']['content']['application/json']
...
export type UpdateProjectsByProjectIdMcpConfigResponse =
  paths['/api/projects/{projectId}/mcp/config']['put']['responses']['200']['content']['application/json']
export type UpdateProjectsByProjectIdMcpConfigRequest =
  paths['/api/projects/{projectId}/mcp/config']['put']['requestBody']['content']['application/json']
export type DeleteProjectsByProjectIdMcpConfigResponse =
  paths['/api/projects/{projectId}/mcp/config']['delete']['responses']['200']['content']['application/json']
...
export type ListProjectsByProjectIdFlowQueuesResponse =
  paths['/api/projects/{projectId}/flow/queues']['get']['responses']['200']['content']['application/json']
export type ListProjectsByProjectIdFlowQueuesWithStatsResponse =
  paths['/api/projects/{projectId}/flow/queues-with-stats']['get']['responses']['200']['content']['application/json']
...
export type UpdateFlowQueuesByQueueIdRequest =
  paths['/api/flow/queues/{queueId}']['patch']['requestBody']['content']['application/json']
...
export type ListProjectsByProjectIdMcpServersResponse =
  paths['/api/projects/{projectId}/mcp/servers']['get']['responses']['200']['content']['application/json']
export type CreateProjectsByProjectIdMcpServersResponse =
  paths['/api/projects/{projectId}/mcp/servers']['post']['responses']['200']['content']['application/json']
export type CreateProjectsByProjectIdMcpServersRequest =
  paths['/api/projects/{projectId}/mcp/servers']['post']['requestBody']['content']['application/json']
export type ListProjectsByProjectIdMcpServersByServerIdResponse =
  paths['/api/projects/{projectId}/mcp/servers/{serverId}']['get']['responses']['200']['content']['application/json']
export type UpdateProjectsByProjectIdMcpServersByServerIdResponse =
  paths['/api/projects/{projectId}/mcp/servers/{serverId}']['patch']['responses']['200']['content']['application/json']
export type UpdateProjectsByProjectIdMcpServersByServerIdRequest =
  paths['/api/projects/{projectId}/mcp/servers/{serverId}']['patch']['requestBody']['content']['application/json']
export type DeleteProjectsByProjectIdMcpServersByServerIdResponse =
  paths['/api/projects/{projectId}/mcp/servers/{serverId}']['delete']['responses']['200']['content']['application/json']
...
export class TypeSafeApiClient {
  ...
  async updateProject(
    ...
    return this.request<UpdateProjectResponse>('PUT', this.buildPath(`/api/projects/{projectId}`, { projectId }), {
      body: data,
      timeout: options?.timeout
    })
  }
  ...
  async updateTicket(
    ...
    return this.request<UpdateTicketResponse>('PUT', this.buildPath(`/api/tickets/{ticketId}`, { ticketId }), {
      body: data,
      timeout: options?.timeout
    })
  }
  ...
  async getChat(chatId: string | number, options?: { timeout?: number }): Promise<GetChatResponse> {
    return this.request<GetChatResponse>('GET', this.buildPath(`/api/chats/{chatId}`, { chatId }), {
      timeout: options?.timeout
    })
  }
  ...
  async updateChat(
    ...
    return this.request<UpdateChatResponse>('PUT', this.buildPath(`/api/chats/{chatId}`, { chatId }), {
      body: data,
      timeout: options?.timeout
    })
  }
  ...
  async updatePrompt(
    ...
    return this.request<UpdatePromptResponse>('PATCH', this.buildPath(`/api/prompts/{id}`, { id }), {
      body: data,
      timeout: options?.timeout
    })
  }
  ...
  async updatePrompt(
    ...
    return this.request<UpdatePromptResponse>('PUT', this.buildPath(`/api/prompts/{promptId}`, { promptId }), {
      body: data,
      timeout: options?.timeout
    })
  }
   ...
   * List claudeagents
   */
  async getClaudeagents(
    query?: { search?: any; filter?: any; page?: any; limit?: any; sort?: any; order?: any },
    options?: { timeout?: number }
  ): Promise<GetClaudeagentsResponse> {
    return this.request<GetClaudeagentsResponse>('GET', `/api/claudeagents`, {
      params: query,
      timeout: options?.timeout
    })
  }
  ...
  async createClaudeagent(
    data: CreateClaudeagentRequest,
    options?: { timeout?: number }
  ): Promise<CreateClaudeagentResponse> {
    return this.request<CreateClaudeagentResponse>('POST', `/api/claudeagents`, {
      body: data,
      timeout: options?.timeout
    })
  }
   ...
   */
  async getClaudeagent(
    claudeagentId: string | number,
    options?: { timeout?: number }
  ): Promise<GetClaudeagentResponse> {
    return this.request<GetClaudeagentResponse>(
      'GET',
      this.buildPath(`/api/claudeagents/{claudeagentId}`, { claudeagentId }),
      { timeout: options?.timeout }
    )
  }
   ...
   * Update ClaudeAgent
   */
  async updateClaudeagent(
    claudeagentId: string | number,
    data: UpdateClaudeagentRequest,
    options?: { timeout?: number }
  ): Promise<UpdateClaudeagentResponse> {
    return this.request<UpdateClaudeagentResponse>(
      'PUT',
      this.buildPath(`/api/claudeagents/{claudeagentId}`, { claudeagentId }),
      { body: data, timeout: options?.timeout }
    )
   ...
   * Delete ClaudeAgent
   */
  async deleteClaudeagent(
    claudeagentId: string | number,
    options?: { timeout?: number }
  ): Promise<DeleteClaudeagentResponse> {
    return this.request<DeleteClaudeagentResponse>(
      'DELETE',
      this.buildPath(`/api/claudeagents/{claudeagentId}`, { claudeagentId }),
      { timeout: options?.timeout }
    )
   ...
   * List claudecommands
   */
  async getClaudecommands(
    query?: { page?: any; limit?: any; sort?: any; order?: any },
    options?: { timeout?: number }
  ): Promise<GetClaudecommandsResponse> {
    return this.request<GetClaudecommandsResponse>('GET', `/api/claudecommands`, {
      params: query,
      timeout: options?.timeout
    })
  }
   ...
   */
  async createClaudecommand(
    data: CreateClaudecommandRequest,
    options?: { timeout?: number }
  ): Promise<CreateClaudecommandResponse> {
    return this.request<CreateClaudecommandResponse>('POST', `/api/claudecommands`, {
      body: data,
      timeout: options?.timeout
    })
  }
  ...
  async getClaudecommand(
    claudecommandId: string | number,
    options?: { timeout?: number }
  ): Promise<GetClaudecommandResponse> {
    return this.request<GetClaudecommandResponse>(
      'GET',
      this.buildPath(`/api/claudecommands/{claudecommandId}`, { claudecommandId }),
      { timeout: options?.timeout }
    )
  }
   ...
   */
  async updateClaudecommand(
    claudecommandId: string | number,
    data: UpdateClaudecommandRequest,
    options?: { timeout?: number }
  ): Promise<UpdateClaudecommandResponse> {
    return this.request<UpdateClaudecommandResponse>(
      'PUT',
      this.buildPath(`/api/claudecommands/{claudecommandId}`, { claudecommandId }),
      { body: data, timeout: options?.timeout }
    )
   ...
   */
  async deleteClaudecommand(
    claudecommandId: string | number,
    options?: { timeout?: number }
  ): Promise<DeleteClaudecommandResponse> {
    return this.request<DeleteClaudecommandResponse>(
      'DELETE',
      this.buildPath(`/api/claudecommands/{claudecommandId}`, { claudecommandId }),
      { timeout: options?.timeout }
    )
   ...
   * List claudehooks
   */
  async getClaudehooks(
    query?: { page?: any; limit?: any; sort?: any; order?: any },
    options?: { timeout?: number }
  ): Promise<GetClaudehooksResponse> {
  ...
  async getClaudehook(claudehookId: string | number, options?: { timeout?: number }): Promise<GetClaudehookResponse> {
    return this.request<GetClaudehookResponse>(
      'GET',
      this.buildPath(`/api/claudehooks/{claudehookId}`, { claudehookId }),
      { timeout: options?.timeout }
    )
  }
   ...
   * Update ClaudeHook
   */
  async updateClaudehook(
    claudehookId: string | number,
    data: UpdateClaudehookRequest,
    options?: { timeout?: number }
  ): Promise<UpdateClaudehookResponse> {
    return this.request<UpdateClaudehookResponse>(
      'PUT',
      this.buildPath(`/api/claudehooks/{claudehookId}`, { claudehookId }),
      { body: data, timeout: options?.timeout }
    )
   ...
   * Delete ClaudeHook
   */
  async deleteClaudehook(
    claudehookId: string | number,
    options?: { timeout?: number }
  ): Promise<DeleteClaudehookResponse> {
    return this.request<DeleteClaudehookResponse>(
      'DELETE',
      this.buildPath(`/api/claudehooks/{claudehookId}`, { claudehookId }),
      { timeout: options?.timeout }
    )
  ...
  async getAgent(id: string | number, options?: { timeout?: number }): Promise<GetAgentResponse> {
    return this.request<GetAgentResponse>('GET', this.buildPath(`/api/agents/{id}`, { id }), {
      timeout: options?.timeout
    })
  }
  ...
  async updateAgent(
    ...
    return this.request<UpdateAgentResponse>('PUT', this.buildPath(`/api/agents/{id}`, { id }), {
      body: data,
      timeout: options?.timeout
    })
  }
  ...
  async deleteAgent(id: string | number, options?: { timeout?: number }): Promise<DeleteAgentResponse> {
    return this.request<DeleteAgentResponse>('DELETE', this.buildPath(`/api/agents/{id}`, { id }), {
      timeout: options?.timeout
    })
  }
  ...
  async listProjectsByProjectIdCommands(
    projectId: string | number,
    query?: { query?: any; scope?: any; includeGlobal?: any; limit?: any; offset?: any },
    options?: { timeout?: number }
   ...
   */
  async updateProjectsByProjectIdMcpConfig(
    projectId: string | number,
    data: UpdateProjectsByProjectIdMcpConfigRequest,
    options?: { timeout?: number }
  ): Promise<UpdateProjectsByProjectIdMcpConfigResponse> {
    return this.request<UpdateProjectsByProjectIdMcpConfigResponse>(
      'PUT',
      this.buildPath(`/api/projects/{projectId}/mcp/config`, { projectId }),
      { body: data, timeout: options?.timeout }
    )
   ...
   */
  async deleteProjectsByProjectIdMcpConfig(
    projectId: string | number,
    options?: { timeout?: number }
  ): Promise<DeleteProjectsByProjectIdMcpConfigResponse> {
    return this.request<DeleteProjectsByProjectIdMcpConfigResponse>(
      'DELETE',
      this.buildPath(`/api/projects/{projectId}/mcp/config`, { projectId }),
      { timeout: options?.timeout }
    )
   ...
   */
  async listProjectsByProjectIdFlowQueues(
    projectId: string | number,
    options?: { timeout?: number }
  ): Promise<ListProjectsByProjectIdFlowQueuesResponse> {
    return this.request<ListProjectsByProjectIdFlowQueuesResponse>(
      'GET',
      this.buildPath(`/api/projects/{projectId}/flow/queues`, { projectId }),
      { timeout: options?.timeout }
    )
  }
   ...
   */
  async listProjectsByProjectIdFlowQueuesWithStats(
    projectId: string | number,
    options?: { timeout?: number }
  ): Promise<ListProjectsByProjectIdFlowQueuesWithStatsResponse> {
    return this.request<ListProjectsByProjectIdFlowQueuesWithStatsResponse>(
      'GET',
      this.buildPath(`/api/projects/{projectId}/flow/queues-with-stats`, { projectId }),
      { timeout: options?.timeout }
    )
  }
   ...
   */
  async listProjectsByProjectIdMcpServers(
    projectId: string | number,
    options?: { timeout?: number }
  ): Promise<ListProjectsByProjectIdMcpServersResponse> {
    return this.request<ListProjectsByProjectIdMcpServersResponse>(
      'GET',
      this.buildPath(`/api/projects/{projectId}/mcp/servers`, { projectId }),
      { timeout: options?.timeout }
    )
  }
   ...
   */
  async createProjectsByProjectIdMcpServers(
    projectId: string | number,
    data: CreateProjectsByProjectIdMcpServersRequest,
    options?: { timeout?: number }
  ): Promise<CreateProjectsByProjectIdMcpServersResponse> {
    return this.request<CreateProjectsByProjectIdMcpServersResponse>(
      'POST',
      this.buildPath(`/api/projects/{projectId}/mcp/servers`, { projectId }),
      { body: data, timeout: options?.timeout }
    )
   ...
   */
  async listProjectsByProjectIdMcpServersByServerId(
    projectId: string | number,
    serverId: string | number,
    options?: { timeout?: number }
  ): Promise<ListProjectsByProjectIdMcpServersByServerIdResponse> {
    return this.request<ListProjectsByProjectIdMcpServersByServerIdResponse>(
      'GET',
      this.buildPath(`/api/projects/{projectId}/mcp/servers/{serverId}`, { projectId, serverId }),
      { timeout: options?.timeout }
    )
  }
   ...
   */
  async updateProjectsByProjectIdMcpServersByServerId(
    projectId: string | number,
    serverId: string | number,
    data: UpdateProjectsByProjectIdMcpServersByServerIdRequest,
    options?: { timeout?: number }
  ): Promise<UpdateProjectsByProjectIdMcpServersByServerIdResponse> {
    return this.request<UpdateProjectsByProjectIdMcpServersByServerIdResponse>(
      'PATCH',
      this.buildPath(`/api/projects/{projectId}/mcp/servers/{serverId}`, { projectId, serverId }),
      { body: data, timeout: options?.timeout }
    )
   ...
   */
  async deleteProjectsByProjectIdMcpServersByServerId(
    projectId: string | number,
    serverId: string | number,
    options?: { timeout?: number }
  ): Promise<DeleteProjectsByProjectIdMcpServersByServerIdResponse> {
    return this.request<DeleteProjectsByProjectIdMcpServersByServerIdResponse>(
      'DELETE',
      this.buildPath(`/api/projects/{projectId}/mcp/servers/{serverId}`, { projectId, serverId }),
      { timeout: options?.timeout }
    )
