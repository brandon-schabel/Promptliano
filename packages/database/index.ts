...
export const CreateTicketSchema = createTransformedInsertSchema(insertTicketSchema).merge(z.object({
...
export const CreateTaskSchema = createTransformedInsertSchema(insertTicketTaskSchema).merge(z.object({
  suggestedFileIds: commonJsonTransforms.suggestedFileIds.optional(),
...
export const CreateChatMessageSchema = createTransformedInsertSchema(insertChatMessageSchema).merge(z.object({
...
export const CreatePromptSchema = createTransformedInsertSchema(insertPromptSchema).merge(z.object({
  tags: commonJsonTransforms.tags.optional()
}))
...
export const CreateProviderKeySchema = createTransformedInsertSchema(insertProviderKeySchema).merge(z.object({
...
export const CreateActiveTabSchema = createTransformedInsertSchema(insertActiveTabSchema).merge(z.object({
