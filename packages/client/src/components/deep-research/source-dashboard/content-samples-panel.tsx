      ...
      <Card className={className}>
        ...
        <CardContent className="text-center py-8">
          ...
          <p className="text-xs text-muted-foreground mt-1">
            Content will appear here as pages are crawled
          </p>
        </CardContent>
      </Card>
    )
...
function ContentSampleCard({
  ...
  sample: NonNullable<ContentSamplesPanelProps['samples']>[number]
}) {
 ...
 */
export function ContentSamplesGrid({
  samples
}: Pick<ContentSamplesPanelProps, 'samples'>) {
