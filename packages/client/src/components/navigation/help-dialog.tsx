          ...
          <TabsContent value='shortcuts'>
            <ScrollArea className='h-[60vh] pr-4'>
              <div className='space-y-2 p-4'>
                ...
                <p>
                  <AppShortcutDisplay shortcut='open-command-palette' />: Open command palette
                </p>
                <p>
                  <AppShortcutDisplay shortcut='open-help' />: Open this help
                </p>
                <p>
                  <AppShortcutDisplay shortcut='focus-file-search' />: Focus file search
                </p>
                <p>
                  <AppShortcutDisplay shortcut='focus-file-tree' />: Focus file tree
                </p>
                <p>
                  <AppShortcutDisplay shortcut='focus-prompts' />: Focus prompts
                </p>
                <p>
                  <AppShortcutDisplay shortcut='focus-prompt-input' />: Focus prompt input
                </p>

                <h3 className='font-semibold mt-4 mb-2'>File Search & Autocomplete</h3>
                <p>
                  <ShortcutDisplay shortcut={['up', 'down']} delimiter=' / '></ShortcutDisplay>: Navigate through
                  suggestions
                </p>
                <p>
                  <ShortcutDisplay shortcut={['enter', 'space']} delimiter=' / ' />: Select highlighted file
                </p>
                <p>
                  <ShortcutDisplay shortcut={['right']} />: Preview highlighted file
                </p>
                <p>
                  <AppShortcutDisplay shortcut='close-suggestions' />: Close suggestions
                </p>

                <h3 className='font-semibold mt-4 mb-2'>File Tree Navigation</h3>
                <p>
                  <ShortcutDisplay shortcut={['up', 'down']} delimiter=' / ' />: Navigate items
                </p>
                <p>
                  <ShortcutDisplay shortcut={['left', 'right']} delimiter=' / ' />: Collapse/Expand folders
                </p>
                <p>
                  <AppShortcutDisplay shortcut='select-file' />: Toggle file/folder selection
                </p>
                <p>
                  <AppShortcutDisplay shortcut='select-folder' />: View file or toggle folder
                </p>

                <h3 className='font-semibold mt-4 mb-2'>Selected Files</h3>
                <p>
                  <ShortcutDisplay shortcut={['r', '[1-9]']} />: Remove file from selected list
                </p>
                <p>
                  <ShortcutDisplay shortcut={['delete', 'backspace']} delimiter=' / ' />: Remove file
                </p>

                <h3 className='font-semibold mt-4 mb-2'>General Controls</h3>
                <p>
                  <AppShortcutDisplay shortcut='undo' />: Undo
                </p>
                <p>
                  <AppShortcutDisplay shortcut='redo' />: Redo
                </p>
          ...
          <TabsContent value='agent'>
            <ScrollArea className='h-[60vh] pr-4'>
              <div className='space-y-3 p-4 text-sm'>
                ...
                <p>
                  The AI Agent (introduced in v0.5.0) automates coding tasks by planning and executing changes based on
                  your instructions and selected context.
                </p>

                <h4 className='font-semibold mt-3 mb-1'>How the Agent Works:</h4>
                <ol className='list-decimal list-inside space-y-2'>
                  <li>
                    <strong>Context Gathering:</strong> You provide the context by selecting relevant project files,
                    choosing guiding prompts, and writing your main task description in the "User Input" field on the
                    project page.
                  </li>
                  <li>
                  ...
                  <li>
                    <strong>Planning Phase:</strong> Upon starting a run, the system sends your context to a specialized
                    "Planning Agent." This AI analyzes your request and the provided file information to create a
                    structured plan, breaking down the goal into a series of specific tasks (e.g., "modify function X in
                    file Y.ts," "create new file Z.ts with specified content").
                  </li>
                  <li>
                    <strong>Execution Phase (Coding Agent):</strong> For each task in the plan, a "Coding Agent" takes
                    over. It receives the specific task instruction and the content of the target file (if it exists).
                    The Coding Agent then generates the necessary code modifications or new file content.
                  </li>
                  <li>
                    <strong>Proposal:</strong> Once all tasks are processed, the agent presents all proposed changes
                    (additions, modifications, deletions) to you for review in the "Confirm" tab of the Agent Control
                    Dialog.
                  </li>
                  <li>
                    <strong>Confirmation:</strong> You review the proposed changes. If satisfied, you confirm, and the
                    agent writes the changes directly to your file system. Otherwise, you can discard them by closing
                    the dialog or not confirming.
                  </li>
                </ol>
                ...
                <ul className='list-disc list-inside space-y-2 pl-4 mt-1'>
                  <li>
                    ...
                    <ul className='list-circle list-inside pl-4 mt-1 space-y-1'>
                      ...
                      <li>
                        It provides an overview of the context that will be sent to the agent: your user input, the list
                  ...
                  <li>
                    ...
                    <ul className='list-circle list-inside pl-4 mt-1 space-y-1'>
                      <li>
                        This tab becomes active once an agent run starts or if you select a past run using the Run ID
                        selector at the top of the dialog.
                      </li>
                      <li>
                        By default, it shows a live stream of logs from the agent's execution, providing insights into
                        its decision-making process, task execution, and any errors encountered.
                      </li>
                      <li>
                        A toggle switch allows you to switch from "Viewing Logs" to "Viewing Raw Data." The raw data
                        view displays the complete JSON object representing the agent run's state, including the
                        detailed task plan, file contents, and other metadata. This is useful for debugging or deeper
                        analysis.
                      </li>
                      <li>
                        Use the
                  ...
                  <li>
                    ...
                    <ul className='list-circle list-inside pl-4 mt-1 space-y-1'>
                      <li>
                        After the agent has finished processing all tasks and generated code changes, this tab displays
                      ...
                      <li>
                        If you don't want to apply the changes, you can simply close the dialog or navigate to another
                        tab. The changes won't be applied unless explicitly confirmed.
                      </li>
                    </ul>
                  </li>
                </ul>
                <p className='mt-3'>
                  <strong>Tip:</strong> Provide clear, specific instructions in the "User Input" and select only the
                  most relevant files and prompts for the best results. The agent's performance depends heavily on the
                  quality and focus of the context you provide.
                </p>
              </div>
            </ScrollArea>
          </TabsContent>
          <TabsContent value='chat'>
            <ScrollArea className='h-[60vh] pr-4'>
              <div className='space-y-3 p-4 text-sm'>
                ...
                <p>
                  The chat interface provides a straightforward way to interact directly with various Large Language
                  Models (LLMs).
                </p>
                <p>
                  Currently, it's a basic chat interface allowing you to send messages to an AI and receive responses.
                  The backend supports multiple LLM providers, giving you flexibility in choosing the model that best
                  suits your needs.
                </p>
                <p>
                  ...
                  . OpenRouter aggregates many different providers and models, allowing you to access a wide array of
                  LLMs seamlessly through a single API key. This simplifies configuration and lets you experiment with
                  various models easily.
                </p>
                <p>
            ...
            <ScrollArea className='h-[60vh] pr-4'>
              <div className='space-y-3 p-4 text-sm'>
                ...
                <ol className='list-decimal list-inside space-y-1'>
                  ...
                  <li>
                    You'll need to provide a name for your project and the **full absolute path** to your project's main
                ...
                <ul className='list-disc list-inside space-y-1 pl-4'>
                  <li>
                    ...
                    <ul className='list-circle list-inside pl-4 mt-1 space-y-0.5'>
                      ...
                      <li>
                        While holding down the <ShortcutDisplay shortcut={['Option']} /> key, select "Copy [FolderName]
                        as Pathname".
                      </li>
                      <li>
                  ...
                  <li>
                    ...
                    <ul className='list-circle list-inside pl-4 mt-1 space-y-0.5'>
                      ...
                      <li>
                        Click in the address bar at the top; the full path will appear and you can copy it (
                        <ShortcutDisplay shortcut={['Ctrl', 'C']} delimiter=' + ' />
                        ).
                      </li>
                      <li>
                        Alternatively, hold <ShortcutDisplay shortcut={['Shift']} />, then right-click on the folder and
                        select "Copy as path".
                      </li>
                    </ul>
                  </li>
                  <li>
                    ...
                    <ul className='list-circle list-inside pl-4 mt-1 space-y-0.5'>
                      ...
                      <li>
                        Alternatively, in most desktop environments, you can drag the folder from your file manager into
                        a terminal window, and it will paste the full path.
                      </li>
                    </ul>
                  </li>
                </ul>
                ...
                <p>
                  Once your project is synced and you open it, you'll primarily interact with the main project view.
                  This view is typically divided into a few key areas:
                </p>
                <ul className='list-disc list-inside space-y-1 pl-4'>
                  <li>
                    <strong>File Panel (Left):</strong> This panel contains your project's file structure (File Tree)
                    and a search bar at the top. You can explore and select files here.
                  </li>
                  <li>
                    <strong>Prompt Overview Panel (Right):</strong> This is where you manage prompts for the AI, write
                    your main instructions ("User Input"), and initiate actions with the AI.
                  </li>
                </ul>
                ...
                <ul className='list-disc list-inside space-y-1 pl-4'>
                  ...
                  <li>
                    <strong>Text Search:</strong> Use the "File Search" input field (
                    <AppShortcutDisplay shortcut='focus-file-search' /> or <ShortcutDisplay shortcut={['mod', 'f']} />)
                    located above the File Tree in the File Panel. You can search for files by name or toggle the option
                ...
                <p className='mt-2'>
                  As you select files, they appear in the "Selected Files" list (usually on the right side of the File
                  Panel or in a drawer on smaller screens) and contribute to the total token count for your context. Aim
                  to include only the most relevant files to keep your context focused, effective, and within model
                  limits.
                </p>

                <h4 className='font-semibold mt-3 mb-1'>4. Selecting and Using Prompts</h4>
                <p>
                  In the Prompt Overview Panel (right side), below the token usage bar, you'll find the "Project
                  Prompts" list. These are reusable instructions or guidelines for the AI. You can select one or
                  multiple prompts from this list by checking the box next to their names.
                </p>
                <p>
                  Selected prompts are combined with your selected files and the text you enter in the "User Input"
                  field to form the complete context sent to the AI. Use prompts to dictate desired traits of the
                  output, such as coding style, tone, specific formats to follow, or common instructions you use
                  frequently.
                </p>
                <p>
                ...
                <p>
                  Once you've selected your files, chosen your prompts, and written your main request in the "User
                  Input" field in the Prompt Overview Panel, you have a few ways to proceed:
                </p>
                <ul className='list-disc list-inside space-y-1 pl-4'>
                  <li>
          ...
          <TabsContent value='keys'>
            <ScrollArea className='h-[60vh] pr-4'>
              <div className='space-y-3 p-4 text-sm'>
                ...
                <p>
                  <strong>AI Providers</strong> are companies or services that offer access to powerful Large Language
                  Models (LLMs). Think of them as the companies that build and host the AI technology. Examples include
                  OpenAI, Anthropic, and Google.
                </p>
                <p>
                  <strong>Models</strong> are the specific AI programs or algorithms developed by these providers. Each
          ...
          <TabsContent value='prompts'>
            <ScrollArea className='h-[60vh] pr-4'>
              <div className='space-y-3 p-4 text-sm'>
                ...
                <p>
                  The "Prompts" page is your central hub for creating, organizing, and managing a library of reusable
                  prompts. These prompts can be used to guide the AI in various tasks, ensuring consistency and
                ...
                <ol className='list-decimal list-inside space-y-1'>
                  ...
                  <li>
                    Enter the prompt content in the designated text area. This is where you craft your instructions,
                    context, and desired output format for the AI.
                  </li>
                ...
                <ol className='list-decimal list-inside space-y-1'>
                  ...
                  <li>
                    Click on the prompt entry (or an "Edit" button if available). This will open the prompt in an
                    editing interface.
                  </li>
                ...
                <ol className='list-decimal list-inside space-y-1'>
                  ...
                  <li>
                    Click the "Delete" button (often represented by a trash can icon) associated with the prompt entry.
                  </li>
                ...
                <p>
                  While the current version provides a simple list, future updates may include features for better
                  organization, such as: (Note: These features may not be available yet.)
                </p>
                <ul className='list-disc list-inside space-y-1 pl-4'>
                  <li>
                    **Tagging/Labeling:** Assigning keywords or categories to prompts for easier filtering and
                    searching.
                  </li>
                ...
                <p className='mt-2'>
                  Effective organization will help you quickly find the right prompt for your task as your library
                  grows.
                </p>

                <h4 className='font-semibold mt-3 mb-1'>Importing Prompts into Projects:</h4>
                <p>
                  One of the key features of the prompt library is the ability to import prompts into specific projects.
                  This allows you to curate a set of relevant prompts for each codebase or type of task you work on.
                </p>
                <p>To import prompts into a project:</p>
                <ol className='list-decimal list-inside space-y-1'>
                  <li>Navigate to the specific project you are working on.</li>
                  <li>
                    Look for a "Prompts" section or tab within the project interface (usually in the Prompt Overview
                    Panel).
                  </li>
                  <li>
                    There should be an option to "Import Prompts" or "Add Prompts from Library" (often via a menu or
                    button in the "Project Prompts" header).
                  </li>
                  ...
                  <li>
                    Once imported, these prompts will be readily available for use when interacting with the AI within
                    that project's context.
                  </li>
                </ol>
                <p className='mt-2'>
                  Importing prompts helps keep your project-specific AI interactions focused and efficient, preventing
                  clutter from your entire prompt library.
                </p>
              </div>
            </ScrollArea>
          </TabsContent>
