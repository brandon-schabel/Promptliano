        ...
        <CardContent className='flex-1 flex items-center justify-center'>
          <div className='text-center space-y-4'>
            ...
            <div>
              ...
              <p className='text-sm text-muted-foreground mt-1'>Unable to connect to {url}</p>
              <p className='text-xs text-muted-foreground mt-2'>Make sure the service is running and accessible</p>
            </div>
