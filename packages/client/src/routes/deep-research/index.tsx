...
function DeepResearchPage() {
  ...
  const filteredRecords = useMemo(() => {
    ...
    if (selectedFilter === 'active') {
      filtered = filtered.filter((r: any) => ['initializing', 'gathering', 'processing', 'building'].includes(r.status))
    ...
    <div className='max-w-7xl mx-auto p-6 space-y-6'>
      <div className='flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4'>
        <div>
          ...
          <p className='text-muted-foreground mt-1'>AI-powered comprehensive research and document generation</p>
        </div>
          ...
          <ScrollArea className='max-h-[calc(90vh-12rem)] pr-4'>
            <div className='space-y-4'>
              ...
              <div>
                ...
                />
                <p className='text-xs text-muted-foreground mt-1'>Select the AI model tier for research generation</p>
              </div>
              ...
              <CrawlConfigForm
                ...
                onRelevanceThresholdChange={(threshold) =>
                  setNewResearch({ ...newResearch, crawlRelevanceThreshold: threshold })
                }
              />
            </div>
          </ScrollArea>
