...
test.describe('Navigation Tests', () => {
  ...
  test('should navigate to providers section', async () => {
    ...
    const hasProvidersContent = await appPage.isElementVisible('[data-testid="providers-view"], .providers-content', 2000)
  ...
  test('should open manage projects dialog', async () => {
    ...
    const hasProjectContent = await appPage.isElementVisible('text="Open Project", text="Create", text="New Project"', 2000)
