...
test.describe('Basic Smoke Tests', () => {
  ...
  test('should have basic navigation elements', async ({ page }) => {
    ...
    const hasSidebar =
      (await page
        .locator('[data-testid="app-sidebar"], [data-sidebar="sidebar"], [data-testid="sidebar-container"]')
        .count()) > 0
    ...
    console.log(
      `Navigation elements found - Sidebar: ${hasSidebar}, Main: ${hasMainContent}, Command Palette: ${hasCommandPalette}`
    )
