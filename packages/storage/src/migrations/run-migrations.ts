...
import { baselineV1Migration } from './001-baseline-v1'
...
const migrations: Migration[] = [
  // v1.0 baseline - consolidates all previous development migrations
  baselineV1Migration
  // Future migrations will be added here starting from version 2
]
