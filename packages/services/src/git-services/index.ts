...
export const getProjectGitStatus = (projectId: number) => gitStatusService.getProjectGitStatus(projectId)

export const clearGitStatusCache = (projectId?: number) => gitStatusService.clearCache(projectId)

export const stageFiles = (projectId: number, filePaths: string[]) => gitStatusService.stageFiles(projectId, filePaths)

export const unstageFiles = (projectId: number, filePaths: string[]) =>
  gitStatusService.unstageFiles(projectId, filePaths)

export const stageAll = (projectId: number) => gitStatusService.stageAll(projectId)

export const unstageAll = (projectId: number) => gitStatusService.unstageAll(projectId)

export const getFileDiff = (projectId: number, filePath: string, options?: { commit?: string; staged?: boolean }) =>
  gitStatusService.getFileDiff(projectId, filePath, options)

export const clean = (projectId: number, options?: { directories?: boolean; force?: boolean; dryRun?: boolean }) =>
  gitStatusService.clean(projectId, options)

// Commit operations
export const commitChanges = (projectId: number, message: string) => gitCommitService.commitChanges(projectId, message)
...
export const cherryPick = (projectId: number, commitHash: string) => gitCommitService.cherryPick(projectId, commitHash)

export const revert = (projectId: number, commitHash: string, options?: { noCommit?: boolean }) =>
  gitCommitService.revert(projectId, commitHash, options)

export const blame = (projectId: number, filePath: string) => gitCommitService.blame(projectId, filePath)

export const reset = (projectId: number, ref: string, mode: 'soft' | 'mixed' | 'hard' = 'mixed') =>
...
export const getCommitDetail = (projectId: number, commitHash: string, includeFileContents: boolean = false) =>
  gitCommitService.getCommitDetail(projectId, commitHash, includeFileContents)

// Branch operations
export const getBranches = (projectId: number) => gitBranchService.getBranches(projectId)

export const getCurrentBranch = (projectId: number) => gitBranchService.getCurrentBranch(projectId)

export const createBranch = (projectId: number, branchName: string, startPoint?: string) =>
...
export const deleteBranch = (projectId: number, branchName: string, force: boolean = false) =>
...
export const getBranchesEnhanced = (projectId: number) => gitBranchService.getBranchesEnhanced(projectId)

// Stash operations
export const stash = (projectId: number, message?: string) => gitStashService.stash(projectId, message)

export const stashList = (projectId: number) => gitStashService.stashList(projectId)
...
// Remote operations
export const getRemotes = (projectId: number) => gitRemoteService.getRemotes(projectId)

export const addRemote = (projectId: number, name: string, url: string) =>
  gitRemoteService.addRemote(projectId, name, url)

export const removeRemote = (projectId: number, name: string) => gitRemoteService.removeRemote(projectId, name)

export const fetch = (projectId: number, remote: string = 'origin', options?: { prune?: boolean }) =>
  gitRemoteService.fetch(projectId, remote, options)

export const pull = (projectId: number, remote: string = 'origin', branch?: string, options?: { rebase?: boolean }) =>
...
export const getTags = (projectId: number) => gitRemoteService.getTags(projectId)

export const createTag = (projectId: number, tagName: string, options?: { message?: string; ref?: string }) =>
  gitRemoteService.createTag(projectId, tagName, options)

export const deleteTag = (projectId: number, tagName: string) => gitRemoteService.deleteTag(projectId, tagName)

// Worktree operations
export const getWorktrees = (projectId: number) => gitWorktreeService.getWorktrees(projectId)
...
export const removeWorktree = (projectId: number, worktreePath: string, force: boolean = false) =>
  gitWorktreeService.removeWorktree(projectId, worktreePath, force)

export const lockWorktree = (projectId: number, worktreePath: string, reason?: string) =>
...
// Config operations
export const getConfig = (projectId: number, key?: string, options?: { global?: boolean }) =>
  gitConfigService.getConfig(projectId, key, options)

export const setConfig = (projectId: number, key: string, value: string, options?: { global?: boolean }) =>
