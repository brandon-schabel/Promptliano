...
import { DndContext, closestCenter, useDraggable, DragOverlay } from '@dnd-kit/core'
...
export interface DndDraggableThreeColumnPanelProps {
...
export function DndDraggableThreeColumnPanel({
  ...
  storageKey,
  dragHandleClassName
}: DndDraggableThreeColumnPanelProps) {
