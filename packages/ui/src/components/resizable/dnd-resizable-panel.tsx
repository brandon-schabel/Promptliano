...
export interface DndResizablePanelProps {
...
export function DndResizablePanel({
  leftPanel,
  rightPanel,
  leftPanelClassName,
  rightPanelClassName,
  ...
  return (
    <DndContext onDragEnd={handleDragEnd} onDragStart={handleDragStart}>
      <div id='resizable-container' className={cn('flex flex-row overflow-hidden w-full h-full', className)}>
        {/* Left Panel */}
        <div
        ...
        {!isCollapsed && <Resizer className={resizerClassName} isDragging={isDragging} />}
