...
export function createTanStackTextField(
  config: Omit<Extract<FieldProps, { fieldType: 'text' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'text',
    ...config
...
export function createTanStackTextareaField(
  config: Omit<Extract<FieldProps, { fieldType: 'textarea' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'textarea',
    ...config
...
export function createTanStackSelectField(
  config: Omit<Extract<FieldProps, { fieldType: 'select' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'select',
    ...config
...
export function createTanStackCheckboxField(
  config: Omit<Extract<FieldProps, { fieldType: 'checkbox' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'checkbox',
    ...config
...
export function createTanStackSwitchField(
  config: Omit<Extract<FieldProps, { fieldType: 'switch' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'switch',
    ...config
...
export function createTanStackRadioField(
  config: Omit<Extract<FieldProps, { fieldType: 'radio' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'radio',
    ...config
...
export function createTanStackDateField(
  config: Omit<Extract<FieldProps, { fieldType: 'date' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'date',
    ...config
...
export function createTanStackTagsField(
  config: Omit<Extract<FieldProps, { fieldType: 'tags' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'tags',
    ...config
...
export function createTanStackFileField(
  config: Omit<Extract<FieldProps, { fieldType: 'file' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'file',
    ...config
...
export function createTanStackCustomField(
  config: Omit<Extract<FieldProps, { fieldType: 'custom' }>, 'fieldType'>
): FieldProps {
  return {
    fieldType: 'custom',
    ...config
...
export function createTanStackEmailField(
  config: Omit<Extract<FieldProps, { fieldType: 'text' }>, 'fieldType' | 'type'>
): FieldProps {
...
export function createTanStackPasswordField(
  config: Omit<Extract<FieldProps, { fieldType: 'text' }>, 'fieldType' | 'type'>
): FieldProps {
  return createTanStackTextField({
    ...config,
...
export function createTanStackNumberField(
  config: Omit<Extract<FieldProps, { fieldType: 'text' }>, 'fieldType' | 'type'>
): FieldProps {
  return createTanStackTextField({
    ...config,
...
export function TanStackFormFactory<T extends Record<string, any>>({
  ...
  const renderFields = (fieldsToRender: FieldProps[]) => {
    return fieldsToRender.map((field, index) => <TanStackField key={field.name || index} {...field} />)
  }
  ...
  const renderFieldGroups = () => {
    ...
    return fieldGroups.map((group, index) => <FieldGroupComponent key={index} group={group} />)
  }
  ...
  return (
    <TanStackForm {...formProps}>
      ...
      {fields.length > 0 && <div className='space-y-4'>{renderFields(fields)}</div>}

      {/* Render field groups */}
      {fieldGroups && fieldGroups.length > 0 && <div className='space-y-6'>{renderFieldGroups()}</div>}
    </TanStackForm>
  )
}
