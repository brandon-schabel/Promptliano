...
describe('Modal Factory', () => {
  ...
  describe('createCrudModal', () => {
    ...
    it('should render CreateModal correctly', () => {
      ...
      render(
        <TestWrapper>
          <CreateModal formConfig={formConfig} isOpen={true} onClose={vi.fn()} />
        </TestWrapper>
      )
    ...
    it('should render EditModal with item data', () => {
      ...
      render(
        <TestWrapper>
          <EditModal formConfig={formConfig} isOpen={true} onClose={vi.fn()} item={mockEntity} />
        </TestWrapper>
      )
    ...
    it('should render DeleteModal with confirmation', () => {
      ...
      render(
        <TestWrapper>
          <DeleteModal isOpen={true} onClose={vi.fn()} item={mockEntity} />
        </TestWrapper>
      )
    ...
    it('should render ViewModal with item details', () => {
      ...
      render(
        <TestWrapper>
          <ViewModal isOpen={true} onClose={vi.fn()} item={mockEntity} />
        </TestWrapper>
      )
    ...
    it('should handle create submission', async () => {
      ...
      render(
        <TestWrapper>
          <CreateModal formConfig={formConfig} isOpen={true} onClose={onClose} />
        </TestWrapper>
      )
    ...
    it('should handle delete confirmation', async () => {
      ...
      render(
        <TestWrapper>
          <DeleteModal isOpen={true} onClose={onClose} item={mockEntity} />
        </TestWrapper>
      )
    ...
    const workflowSteps = [
      {
        ...
        component: ({ onNext, isLastStep }: any) => (
          <div>
            <p>Step 1 content</p>
            <button onClick={() => onNext({ step1Data: 'test' })}>{isLastStep ? 'Complete' : 'Next'}</button>
          </div>
        )
      },
      {
        ...
        component: ({ onNext, onPrev, isLastStep }: any) => (
          <div>
            ...
            <button onClick={() => onNext({ step2Data: 'test2' })}>{isLastStep ? 'Complete' : 'Next'}</button>
          </div>
        )
      }
    ]
  ...
  describe('Integration Tests', () => {
    ...
    it('should handle errors gracefully', async () => {
      ...
      render(
        <TestWrapper>
          <CreateModal formConfig={formConfig} isOpen={true} onClose={vi.fn()} initialData={{ name: 'Test' }} />
        </TestWrapper>
      )
