...
export const SummaryOptionsSchema = z
  .object({
    depth: SummaryDepthEnum.default('standard').describe('Level of detail in the summary'),
    focus: z
      .array(z.string())
      .optional()
      .describe('Specific areas to focus on (e.g., ["api", "frontend", "database"])'),
...
export const SummaryVersionSchema = z
  .object({
...
export const EnhancedProjectSummaryResponseSchema = z
  .object({
...
export const FileImportanceSchema = z
  .object({
    fileId: z.string(),
