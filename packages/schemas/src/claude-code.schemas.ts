...
export const ClaudeMessageLenientSchema = z.object({
...
export const ClaudeSessionCursorSchema = z.object({
...
export const ClaudeSessionsPaginatedResponseSchema = z.object({
  success: z.literal(true),
  data: z.array(ClaudeSessionSchema),
  pagination: z.object({
    hasMore: z.boolean(),
...
export const ClaudeSessionsMetadataResponseSchema = z.object({
  success: z.literal(true),
