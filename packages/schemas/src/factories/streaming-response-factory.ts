 ...
 */
export function createWebSocketMessageSchema<T extends z.ZodTypeAny>(dataSchema: T, name?: string) {
 ...
 */
export function createChunkedResponseSchema<T extends z.ZodTypeAny>(chunkSchema: T, name?: string) {
 ...
 */
export function createServerSentEventSchema<T extends z.ZodTypeAny>(dataSchema: T, name?: string) {
  ...
  return z
    .object({
      ...
      data: z.union([z.string(), dataSchema]),
      retry: z.number().optional()
    })
 ...
 */
export function createRealtimeUpdateSchema<T extends z.ZodTypeAny>(dataSchema: T, name?: string) {
 ...
 */
export function createStreamingBatchResponseSchema<T extends z.ZodTypeAny>(itemSchema: T, name?: string) {
