 ...
 */
export function createStandardErrorResponses(additionalErrors: Array<keyof typeof domainErrorResponses> = []) {
 ...
 */
export function createCustomDomainError(code: string, message: string, statusCode: number = 500) {
