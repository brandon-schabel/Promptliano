 ...
 */
export function createInfiniteScrollResponseSchema<T extends z.ZodTypeAny>(itemSchema: T, name?: string) {
 ...
 */
export function createOffsetPaginationResponseSchema<T extends z.ZodTypeAny>(itemSchema: T, name?: string) {
  const schemaName = name || getZodDescription(itemSchema) || 'Item'
 ...
 */
export function createRelayPaginationResponseSchema<T extends z.ZodTypeAny>(itemSchema: T, name?: string) {
  const schemaName = name || getZodDescription(itemSchema) || 'Item'
 ...
 */
export function createTimeBasedPaginationResponseSchema<T extends z.ZodTypeAny>(itemSchema: T, name?: string) {
  const schemaName = name || getZodDescription(itemSchema) || 'Item'
 ...
 */
export function createHybridPaginationResponseSchema<T extends z.ZodTypeAny>(itemSchema: T, name?: string) {
  const schemaName = name || getZodDescription(itemSchema) || 'Item'
