 ...
 */
export const mcpToolStatisticsSchema = z
  .object({
    id: z.number(),
    toolName: z.string(),
    projectId: z.number().nullable().optional(),
 ...
 */
export const mcpToolChainSchema = z
  .object({
    id: z.number(),
    chainId: z.string(),
 ...
 */
export const mcpExecutionQuerySchema = z
  .object({
 ...
 */
export const mcpExecutionQueryRequestSchema = z
  .object({
    projectId: z
      .string()
 ...
 */
export const mcpAnalyticsRequestSchema = z
  .object({
    projectId: z.number().optional(),
 ...
 */
export const mcpAnalyticsOverviewSchema = z
  .object({
    totalExecutions: z.number(),
 ...
 */
export const mcpExecutionTimelineSchema = z
  .object({
    timestamp: unixTSSchemaSpec,
 ...
 */
export const mcpExecutionListResponseSchema = z
  .object({
