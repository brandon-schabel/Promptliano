...
export const FileSummaryStatusSchema = z
  .object({
    fileId: z.number(),
...
export const BatchSummaryOptionsSchema = z
  .object({
...
export const SummaryProgressSchema = z
  .object({
    projectId: z.number(),
    batchId: z.string(),
...
export const EnhancedFileSummarySchema = z
  .object({
...
// Batch result schema
export const BatchSummaryResultSchema = z
  .object({
    batchId: z.string(),
    projectId: z.number(),
...
export const FileSummarizationStatsSchema = z
  .object({
    projectId: z.number(),
    totalFiles: z.number(),
