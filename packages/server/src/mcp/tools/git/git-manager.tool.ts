  ...
  inputSchema: {
    ...
    properties: {
      action: {
        ...
        enum: ['status', 'stage_files', 'unstage_files', 'stage_all', 'unstage_all', 'commit', 'branches', 'current_branch', 'create_branch', 'switch_branch', 'delete_branch', 'merge_branch', 'log', 'log_enhanced', 'commit_details', 'commit_detail', 'file_diff', 'commit_diff', 'cherry_pick', 'remotes', 'add_remote', 'remove_remote', 'fetch', 'pull', 'push', 'tags', 'create_tag', 'delete_tag', 'stash', 'stash_list', 'stash_apply', 'stash_drop', 'stash_pop', 'stash_clear', 'reset', 'checkout', 'rebase', 'revert', 'clone', 'get_ignored_files', 'add_to_gitignore', 'blame', 'clean', 'config_get', 'config_set', 'branches_enhanced', 'worktree_list', 'worktree_add', 'worktree_remove', 'worktree_lock', 'worktree_unlock', 'worktree_prune']
      },
      projectId: {
        type: 'number',
