...
- Factors: ${analysis.factors.join(', ')}`
          ...
          case TaskManagerAction.FILTER: {
            const projectId = validateRequiredParam(data?.projectId, 'projectId', 'number', '<PROJECT_ID>')
